...
public class outPic {
    ...
    public static void main(String[] args) {
        //获取图片  将图片信息把存到数组b中
        byte[] b = outPic.imgArray("G:\\文档\\java\\java图解\\字符串拼接特性.jpg");
        //通过数组B写到文件中
        outPic.writImg(b, "img.txt");
        //读取二进制文件保存到一个数组中
        byte[] c = outPic.imageIn("img.txt");
        //通过数组c  输出图片
        outPic.writImg(c, "img.jpg");
    }

    /**
     * 读取接口
     */
    public void outputPicture(String path){
        //获取图片  将图片信息把存到数组b中
        byte[] b = outPic.imgArray(path);
        //通过数组B写到文件中
        outPic.writImg(b, "img.txt");
        //读取二进制文件保存到一个数组中
        byte[] c = outPic.imageIn("img.txt");
